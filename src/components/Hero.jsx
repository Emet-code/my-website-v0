  ...
  return (
    <div id="hero" className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white">
        ...
        */}
        ...
        className="text-4xl sm:text-5xl md:text-6xl xl:text[84px] font-medium xl:leading-[95px] max-w-5xl">Truth in Technology, <span className="bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent">Excellence </span>in Execution</motion.h1>
        ...
        className="text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3">
            Connecting truth to technology, transforming ideas into interactive digital realities
        </motion.p>
        ...
        className="relative">
            <img src={assets.hero_img} className="w-full max-w-6xl rounded-3xl" alt="" />
